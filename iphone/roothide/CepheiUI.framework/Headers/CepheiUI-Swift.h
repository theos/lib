...
/// <code>-[UIColor hb_initWithPropertyListValue:]</code> as per usual.
/// <ul>
///   <li>
...
/// <ul>
///   <li>
///     see: <code>+hb_colorWithInterfaceStyleVariants:</code>
///   </li>
/// </ul>
///
/// returns:
/// If the color is already a dynamic color, returns the receiver. Otherwise, a new dynamic
/// color object.
